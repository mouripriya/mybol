		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BOL",
									"targetURL": "#commouribolmouribol-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"commouribolmouribol-display": {
								"semanticObject": "commouribolmouribol",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.mouribol.mouribol",
									"url": sap.ui.require.toUrl("com/mouribol/mouribol")
								}
							}
						}
					}
